...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-primary text-white bg-lightblue disabled elevation-4 sidebar-no-expand">
        ...
        <img src="    https://www.rajagirihospital.com/images/logo.png" alt=""class="logo"style="opacity: 1;width: 5.5rem;height: 3rem;max-height: unset">
        <span class="brand-text font-weight-light">
          <?php echo $_settings->info('') ?></span>
        </a>
        <!-- Sidebar -->
